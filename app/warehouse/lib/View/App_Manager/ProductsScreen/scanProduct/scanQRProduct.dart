...
class ScanQRProduct extends StatefulWidget {
  const ScanQRProduct({Key key}) : super(key: key);

  @override
  _ScanQRProductState createState() => _ScanQRProductState();
}

class _ScanQRProductState extends State<ScanQRProduct> {
